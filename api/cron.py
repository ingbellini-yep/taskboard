"""
Vercel Serverless Function — digest mattutino (Vercel Cron 7:20 ora italiana).
Schedule: "20 5 * * *" UTC (= 7:20 CEST / 6:20 CET).
URL: https://<dominio>/api/cron
"""
...
class handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self) -> None:
        ...
        if CRON_SECRET and auth != expected:
